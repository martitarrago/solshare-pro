...
const NewCommunityWizard = () => {
  ...
  if (isComplete) {
    return (
      <div className="max-w-lg mx-auto flex flex-col items-center justify-center py-20 text-center animate-scale-in">
        ...
        <h2 className="text-2xl font-bold text-foreground mb-2">¡Comunidad creada!</h2>
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      <div>
        <h1 className="text-xl font-bold text-foreground">Nueva comunidad</h1>
